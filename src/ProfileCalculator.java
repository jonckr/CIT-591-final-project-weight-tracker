...
public class ProfileCalculator {
	 ...
	 * @return
	 */
	public String[] generateOutput(double weightToLose, int targetDays, double dailyEnergyExpenditure, int dailyCaloriesLoss, int dailyCaloricIntake) {
		String [] myArrayOutput = new String [5];
		myArrayOutput[0] = String.valueOf(weightToLose);
		myArrayOutput[1] = String.valueOf(targetDays);
		myArrayOutput[2] = String.valueOf(dailyEnergyExpenditure);
		myArrayOutput[3] = String.valueOf(dailyCaloriesLoss);
		myArrayOutput[4] = String.valueOf(dailyCaloricIntake);
